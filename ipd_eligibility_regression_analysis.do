...
**
** 11/18/2015
** Simple regression analysis to test impact of PCV on pneumonia
...
** input file
local inFile "`dir'/data/ipd_mrates_elig.xls"
...
** output for graphs
local graphOutFile "`dir'/output/ipd_graphs_stratified"
...
** regress ipd including eligibility
do "`regFunction'" cases ipd 1 eligible
** ----------------------------------------------------
...
do "`stratifiedGraphFunction'" "cases" "ipd" "PCV Introduction and IPD Cases" "" "6" "`introduction_end'" "`introduction_start'" "eligible"
